...
const HelloWorldPage = React.lazy(() =>
  import(
    /* webpackChunkName: "HelloWorldPage" */ './HelloWorld/HelloWorld'
  ).then(module => ({
    default: module.HelloWorldPage,
  }))
);
...
export const usePages = () => {
  ...
  // HelloWorld Route
  const HelloWorld: PageType = {
    path: 'hello-world',
    element: <HelloWorldPage />,
    menuLabel: t('Hello World', { ns: 'Menu' }),
    isShownInMainMenu: true,
  ...
  const Pages: PageType[] = [HelloWorld];
